...
import { KLINE_SET, KLINE_GET } from 'store/modules/ws/types';
...
export default class TradingViewComponent extends Vue {
    @Action(KLINE_SET) private setKline!: Function;
    @Getter(KLINE_GET) private klineData!: any[];
    feed:any = null
    chart:any = null
    ...
    constructor() {
        super()
        this.createData()
        this.setKline(this.bars)
    }

    mounted() {
        this.feed = this.createFeed();
        console.error("!212", TradingView)
    ...
    createFeed() {
        ...
        Datafeed.Container.prototype.subscribeBars = function(symbolInfo:any, resolution:any, onRealtimeCallback:any, listenerGUID:any, onResetCacheNeededCallback:any) {
            console.error('12312312', _this.klineData)
            _this.klineData.forEach(function (bar:any) { // in subscribeBars
